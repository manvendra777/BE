    ...
    render() {
        return (
            <div>
                ...
                <div style={{marginTop:100,display:"flex",margin:"auto",width:"90%"}} >
                 ...
                 <Link to= "mentorform"><Cards info="Startup mentor is person who help you establish your startup in the very initial days.
As a startup founder one may have many things to figure out depending upon what kind of business it is. And founders are not equally skilled in all aspects. So, they seek for person who have done the same before or experience doing the same." type="Mentor" src= "./assets/mentor.jpeg"/></Link>
