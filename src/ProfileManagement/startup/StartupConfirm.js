...
class StartupConfirm extends React.Component{ 
   ...
   continue= e=>{
       ...
       var data={
        ...
        axios.post('http://localhost:8085/security/setStartup?userName='+cookieName) //startup 
        // End of code
   ...
   back= e=>{
    ...
    render(){
        ...
        const {values: {firstName, lastName, age, email, qualification, phone_no, userID, domain, DIPP_no, 
            Address, city, country, postalCode, startupName,startupDescription, websiteURL, profession,type}}= this.props;
