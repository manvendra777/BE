...
class Startup extends Component {
  ...
  render() {
    const steps = ['Personal details', 'Company details', 'Domain selection', 'Review'];
    ...
    const { firstName, lastName, age, email, qualification, phone_no, userID, domain, DIPP_no,
      Address, city, state, country, postalCode, startupName, startupDescription, websiteURL, profession, domainC } = this.state;

    const values = {
      firstName, lastName, age, email, qualification, phone_no, userID, domain, DIPP_no,
      Address, city, state, country, postalCode, startupName, startupDescription, websiteURL, profession, domainC
    }
