...
class Startup extends Component {
  ...
  submitForm() {
    var self = this;
    axios
      .put("http://54.237.17.61/management/mentor/profile/add", {
        id: this.state.id,
  ...
  createDb() {
    ...
    axios
      ...
      .then((res) => {
        ...
        axios
          .post(
            "http://54.237.17.61/security/setMentor?userName=" +
              Cookies.get("temp")
          )
          .then((res) => {
            Cookies.remove("temp");
  ...
  render() {
    ...
    const getStepContent = (step) => {
      switch (step) {
        ...
        case 1:
          return (
            <Professional handleChange={this.handleChange} values={values} />
          );
        case 2:
          return (
            <Domain
