...
class AdvertiseRight extends Component {
  ...
  getAdByDomain() {
    ...
    var self = this;
    axios
      .get(`http://localhost:8087/advert/getAdByDomain`, {
  ...
  sendFeedBack() {
    var self = this;
    axios
      .post("http://localhost:8087/advert/addFeedback/", {
  ...
  resume = () => {
    setTimeout(
      function () {
        //Start the timer //After 1 second, set render to true
        this.startAds();
      }.bind(this),
      5000
    );
