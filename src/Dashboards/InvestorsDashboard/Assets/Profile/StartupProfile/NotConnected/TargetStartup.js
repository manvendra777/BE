...
class TargetStartup extends Component {
  ...
  getImage() {
    ...
    axios
      .get(
        `http://54.237.17.61/management/startup/photos/` +
  ...
  getInfo() {
    ...
    var persons;
    axios
      .get(`http://54.237.17.61/management/startup/profile/` + id)
      .then((res) => {
        persons = res.data;
        ...
        <Card elevation={3}>
          ...
          >
            ...
            <div style={{ display: "flex", alignText: "center" }}>
              ...
              >
                {" "}
                <h5>{this.state.myProfile.valuation}</h5>
              </div>
            </div>
            <div style={{ display: "flex", alignText: "center" }}>
              <Typography variant="h5" color="primary" gutterBottom>
              ...
              >
                {" "}
                <h5>{this.state.myProfile.percentageOfOwnership}%</h5>
              </div>
            </div>
            <div style={{ display: "flex", alignText: "center" }}>
              <Typography variant="h5" color="primary" gutterBottom>
