...
class Name extends Component {
    ...
    getImage() {
        var self = this;
        var mem;
        axios.get(`http://54.237.17.61/management/investor/photos/`+Cookies.get('id'))
            .then(res => {
                mem = res.data;
	...
	handleSubmit(e){
		...
		axios.post('http://54.237.17.61/management/investor/profile/'+Cookies.get('id'), data = data)
